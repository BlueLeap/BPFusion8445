...
namespace Oracle.RightNow.Cti.Simulator.Messaging {
...
namespace Oracle.RightNow.Cti.Simulator.Messaging {
    ...
    public class RemoteMessagingProvider : IRemoteMessagingProvider, IMessagingProvider {
        ...
        public void Initialize() {
            ...
            _serviceHost.AddServiceEndpoint(typeof(IRemoteMessagingProvider), new NetNamedPipeBinding(), "net.pipe://localhost/oraclerightnow/simulatedswitch");
            _serviceHost.Open();
        }
