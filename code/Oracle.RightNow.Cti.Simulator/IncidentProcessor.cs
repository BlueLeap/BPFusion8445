...
namespace Oracle.RightNow.Cti.Simulator {
    ...
    public class IncidentProcessor {
        ...
        [Import]
        public SimulatedSwitch Switch { get; set; }
        ...
        private Oracle.RightNow.Cti.Simulator.InteractionType getInteractionType(RightNowChannel rightNowChannel) {
            switch (rightNowChannel)
            {
                case RightNowChannel.Email:
                    return Oracle.RightNow.Cti.Simulator.InteractionType.Email;
                case RightNowChannel.Web:
                    return Oracle.RightNow.Cti.Simulator.InteractionType.Web;
            }
