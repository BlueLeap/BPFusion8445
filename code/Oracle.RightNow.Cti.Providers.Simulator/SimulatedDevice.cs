...
namespace Oracle.RightNow.Cti.Providers.Simulator {
    ...
    public class SimulatedDevice : IDevice, ISwitchMessageConsumer {
        ...
        public void Dial(string address) {
            // Not currently supported in the simulator.
        }
        ...
        void ISwitchMessageConsumer.HandleMessage(Cti.Simulator.Messaging.Messages.Message message) {
        }
    }
}