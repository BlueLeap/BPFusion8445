...
namespace Oracle.RightNow.Cti.Providers.Simulator {
    public abstract class SimulatedInteraction : NotifyingObject, IInteraction, ISwitchMessageConsumer {
        private string _id;
        ...
        public SimulatedInteraction(SimulatedProvider provider) {
            Provider = provider;
        ...
        public TimeSpan Duration {
            get {
                if (State == InteractionState.Disconnected)
        ...
        protected SimulatedProvider Provider { get; private set; }
        ...
        public void HandleMessage(Message message) {
            switch (message.Type)
            {
                case Oracle.RightNow.Cti.Simulator.Messaging.SwitchMessageType.Interaction:
